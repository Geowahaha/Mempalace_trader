...
def _worker_result_is_transient(result: Dict[str, Any]) -> bool:
    ...
    if error_code == "cant_route_request" or "cannot route request" in message:
        return False
    if status in {"app_auth_failed", "account_auth_failed"}:
        return False
    ...
    async def execute_trade(
        ...
        *,
        ...
        payload: Dict[str, Any] = {
            ...
            "comment": str(decision_reason)[:120],
        }
        ...
        return TradeResult(
            ...
            executed=ok,
            dry_run=False,
            message=str(data.get("status") or data.get("message") or "ctrader_worker")[:220],
    ...
    async def close_position(
        ...
        *,
        ...
        return CloseResult(
            ...
            dry_run=False,
            message=str(data.get("status") or data.get("message") or "close")[:220],
